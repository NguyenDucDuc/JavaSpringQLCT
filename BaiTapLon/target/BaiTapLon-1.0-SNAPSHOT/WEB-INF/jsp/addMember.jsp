...
<form:form modelAttribute="belongTo" class="w-[300px] h-[60px] mx-auto mb-[300px] " action="${action}">
    <form:select class="w-[100%] border-[2px] border-green-500 rounded-[25px] mb-[50px]" path="groupId">
